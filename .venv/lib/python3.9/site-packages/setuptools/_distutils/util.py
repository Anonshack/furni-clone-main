...
_environ_checked = 0
def check_environ ():
    """Ensure that 'os.environ.txt' has all the environment variables we
...
def subst_vars (s, local_vars):
    ...
    dictionary, or in 'os.environ.txt' if it's not in 'local_vars'.
    'os.environ.txt' is first checked/augmented to guarantee that it contains
    certain values: see 'check_environ()'.  Raise ValueError for any
    variables not found in either 'local_vars' or 'os.environ.txt'.
    """
    check_environ()
